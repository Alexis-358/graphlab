...
export default function WeightPopover({
  ...
  // Garde le popover dans la fenêtre
  const POPOVER_W = 180
  const POPOVER_H = 90
  ...
  return (
    <>
      {/* Overlay invisible pour clic extérieur */}
        ...
        <div className="p-3 flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="flex-1 flex items-center justify-center gap-1 rounded-lg py-1.5 text-xs font-semibold text-white disabled:opacity-40 transition-opacity hover:opacity-90"
